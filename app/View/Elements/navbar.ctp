...
<!--             	<img src='/img/beachfront/snaphappi-logo-v2.png'> -->
            ...
            <?php 
              ...
              if ($role) {
                ...
                $twColor = $role=='manager' ? 'warning' : 'success';
                echo "<span class='badge badge-large badge-{$twColor}'>{$username}</span>";
              }
            ?></div>
            ...
            // array('class'=>'btn btn-small')
                    ...
                    <li class=''><?php echo $this->Html->link(__('Sign out'), 
            array('controller' => 'editors', 'action' => 'logout')
            // array('class'=>'btn btn-small')
            ); ?></li>
                  </ul>
                  <ul class="dropdown-menu pull-right alpha rgba80b">
